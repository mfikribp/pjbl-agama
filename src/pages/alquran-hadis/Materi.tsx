...
export default function Materi() {
  ...
  }, [location.search, playingAudioId]);
                ...
                <div className="p-10 md:p-14 overflow-y-auto flex-grow custom-scrollbar bg-white">
                  <div 
                    className="prose prose-slate max-w-none 
                      ...
                      [&_.verse-ref]:text-[10px] [&_.verse-ref]:font-black [&_.verse-ref]:text-sky-400 [&_.verse-ref]:uppercase [&_.verse-ref]:tracking-[0.2em] [&_.verse-ref]:inline-flex [&_.verse-ref]:items-center [&_.verse-ref]:gap-2
                      [&_.audio-play-btn]:w-10 [&_.audio-play-btn]:h-10 [&_.audio-play-btn]:bg-sky-50 [&_.audio-play-btn]:text-sky-500 [&_.audio-play-btn]:rounded-xl [&_.audio-play-btn]:flex [&_.audio-play-btn]:items-center [&_.audio-play-btn]:justify-center [&_.audio-play-btn]:hover:bg-sky-500 [&_.audio-play-btn]:hover:text-white [&_.audio-play-btn]:transition-all [&_.audio-play-btn]:cursor-pointer [&_.audio-play-btn]:border-none [&_.audio-play-btn]:shadow-sm
